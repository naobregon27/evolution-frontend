      ...
      <div className="w-full">
        ...
        <div>
          ...
          <button
            ...
            className="btn-password px-3 py-1 bg-indigo-100 text-indigo-700 rounded-md hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          >
            Cambiar Contraseña
          </button>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link
              ...
              className="action-card bg-white p-4 md:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-200 flex items-center space-x-4"
            >
              <div className="icon-container user-icon p-3 bg-indigo-100 text-indigo-600 rounded-full">
            ...
            <Link
              ...
              className="action-card bg-white p-4 md:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-200 flex items-center space-x-4"
            >
              <div className="icon-container profile-icon p-3 bg-green-100 text-green-600 rounded-full">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link
              ...
              className="action-card bg-white p-4 md:p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-200 flex items-center space-x-4"
            >
              <div className="icon-container config-icon p-3 bg-amber-100 text-amber-600 rounded-full">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
